					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							...
							<div class="shop-body">
								...
								<a href="#" class="cta-btn">Lihat collection <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
					<!-- /shop -->
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							<h3 class="title">Barang elektronik</h3>
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">Laptop</a></li>
									<li><a data-toggle="tab" href="#tab1">handphone</a></li>
								...
								<div id="tab1" class="tab-pane active">
									...
									<div class="product">
										<div class="product-img">
											<img src="{{ asset('assets/img/product01.png') }}" alt="Product 01">
										...
										<div class="product-body">
											...
											<h4 class="product-price">$3.980.00 <del class alt=""
										</div>
									...
									<div class="product">
										<div class="product-img">
											<img src="{{ asset('assets/img/product02.png') }}" alt="Product 02">
											<div class="product-label">
									...
									<div class="product">
										<div class="product-img">
											<img src="{{ asset('assets/img/product03.png') }}" alt="Product 03">
										</div>
										<div class="product-body">
										...
										<div class="product">
											<div class="product-img">
												<img src="{{ asset('assets/img/product04.png')}}" alt="product04">
											</div>
											<div class="product-body">
												<p class="product-category">Category</p>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="hot-deal">
							...
							<p>Data Barang ElektronikF</p>
							<a class="primary-btn cta-btn" href="#">Lihat barang</a>
						</div>
					</div>
				</div>
				<!-- /row -->
